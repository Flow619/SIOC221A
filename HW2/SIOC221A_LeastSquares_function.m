...
y_bar_2022 = x_2022(1) + x_2022(2)*sin(omega_2022.annual.*time_2022) + x_2022(3)*cos(omega_2022.annual.*time_2022);
...
A_2022 = [ones(1,length(time_2022)); sin(omega_2022.annual.*time_2022); cos(omega_2022.annual.*time_2022); sin(omega_2022.semiannual.*time_2022); cos(omega_2022.semiannual.*time_2022)]';
x_2022 = (inv(transpose(A_2022)*A_2022)) * (transpose(A_2022)*y_2022);
